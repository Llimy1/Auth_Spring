package com.example.auth_spring.service.seller.upload;
...
import com.example.auth_spring.web.exception.UploadException;
    ...
    public List<String> upload(List<MultipartFile> multipartFile) {
        ...
        for (MultipartFile file : multipartFile) {
            ...
            try (InputStream inputStream = file.getInputStream()){
                amazonS3.putObject(new PutObjectRequest(bucket + "/product/image", fileName, inputStream, objectMetadata)
