...
public class CategoryProductInquiryController {
    ...
    public ResponseEntity<ResultDto<ProductListResponseDto>> getCategoryProductList(@ApiParam(name = "categoryName", value = "카테고리명", example = "의류") @RequestParam(value = "categoryName") String categoryName,
