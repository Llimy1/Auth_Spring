...
public class SellerProductResponseDto {
    ...
    @Builder
    public SellerProductResponseDto(String productName, Long productPrice, String brandName, Boolean isDiscount, Integer discountRate, Long viewCount, Long likeCount) {
